      ...
      <div className="w-full min-h-screen bg-black bg-center bg-no-repeat bg-fixed text-white pt-10"
        ...
        <div className="max-w-8xl mx-auto p-4">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="bg-gray-900/70 backdrop-blur-md border border-gray-800/50 rounded-lg p-4 mb-4">
              <div className="mt-2 mb-3 ml-9 flex justify-left gap-4">
                <p className="font-bold text-sm text-left text-red-400">
                  Cualquiera puede probar a rellenar la porra, pero solo dejará enviarla si tu nombre está en la lista de participantes.<br />
                  Asegúrate de poner tu nombre exáctamente (incluyendo primer apellido y tildes).<br />
                  Puedes rellenar esta parte antes o después de los resultados.
                </p>
              </div>
